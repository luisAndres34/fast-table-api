...
async def send_real_email(recipient_email: str, subject: str, html_content: str) -> None:
    """
    Sends an email asynchronously using aiosmtplib configuration.
    Non-blocking native asyncio SMTP delivery.
    """
